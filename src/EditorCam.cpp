...
EditorCam::EditorCam(sf::RenderWindow* window, float deltaScroll, float deltaRotation, float deltaZoomIn, float deltaZoomOut)
    : window{window}
    , deltaScroll{deltaScroll}
    , deltaRotation{deltaRotation}
    , deltaZoomIn{deltaZoomIn}
    , deltaZoomOut{deltaZoomOut}
{}
...
void EditorCam::zoomIn() {
    camera.zoom(deltaZoomIn);
}

void EditorCam::zoomOut() {
    camera.zoom(deltaZoomOut);
}
